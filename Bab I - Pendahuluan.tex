...
Berdasarkan kondisi tersebut, pengembangan perangkat lunak penilaian audit energi pada bangunan gedung menjadi kebutuhan yang relevan dan mendesak. Pengembangan perangkat lunak ini diharapkan dapat membantu auditor dan pengelola gedung dalam melakukan audit energi secara lebih cepat, akurat, terstandar, mendukung evaluasi kinerja sistem kelistrikan, serta mampu mengatasi keterbatasan proses audit energi konvensional yang masih bersifat manual dan tidak terintegrasi.
...
\begin{enumerate}
    \item Bagaimana kondisi sistem kelistrikan gedung saat ini dalam hal pemantauan, pencatatan, dan evaluasi konsumsi energi?
    
    \item Bagaimana merancang perangkat lunak penilaian audit energi yang mampu mendukung proses audit secara lebih cepat, terstandar, dan reliabel?
    
    \item Bagaimana efektivitas perangkat lunak yang dirancang dalam mendukung kepatuhan proses audit energi terhadap standar ISO 50001, ISO 50002, dan SNI 03-6196-2000 pada studi kasus gedung?
\end{enumerate}
...
\begin{enumerate}
    ...
    Tahap ini bertujuan untuk memastikan kesesuaian kebutuhan fungsional dan kualitas nonfungsional sistem. Pengujian dilakukan dengan mengukur tingkat keberhasilan fungsi, efisiensi waktu proses audit dibandingkan dengan metode manual, serta kegunaan sistem melalui penilaian pengguna yang menggunakan skala Likert. Hasil pengujian kemudian dianalisis sebagai evaluasi untuk menilai kinerja dan kebermanfaatan sistem dalam mendukung proses audit energi.
