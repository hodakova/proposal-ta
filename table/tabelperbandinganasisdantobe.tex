...
\begin{tabularx}{\textwidth}{
  ...
  \caption{Perbandingan Kondisi Audit Energi Saat Ini dan Kondisi yang Akan Datang}\label{tbl:perbandinganasisdantobe} \\
  \toprule
  \textbf{Aspek} & \textbf{Kondisi Saat Ini} & \textbf{Kondisi yang Akan Datang} \\
  \midrule
  \endfirsthead

  \caption{Perbandingan Kondisi Audit Energi Saat Ini dan Kondisi yang Akan Datang (lanjutan)} \\
  \toprule
  \textbf{Aspek} & \textbf{Kondisi Saat Ini} & \textbf{Kondisi yang Akan Datang} \\
  \midrule
  \endhead
